...
c------------------------------------------------------------------
      ...
      integer nd, ns, nt, istress, irotlet, idoublet
      real *8 sources(3,ns),targ(3,nt),strslet(nd,3,ns)
...
c     rotlet and doublet
     ...
     1                  zdiff(3)*rvec(3)
                  temp = 1.0d0/r3
                  pot(idim,1,i) = pot(idim,1,i) - rvec(1)*rpl*temp +
     1                            rlet(1)*rpv*temp
                  pot(idim,2,i) = pot(idim,2,i) - rvec(2)*rpl*temp +
     1                            rlet(2)*rpv*temp
                  pot(idim,3,i) = pot(idim,3,i) - rvec(3)*rpl*temp +
     1                            rlet(3)*rpv*temp

                  tempx1 = -(rlet(1) - 3.0d0*zdiff(1)*rpl/r2) / r3
                  tempx2 = -(rlet(2) - 3.0d0*zdiff(2)*rpl/r2) / r3
                  tempx3 = -(rlet(3) - 3.0d0*zdiff(3)*rpl/r2) / r3
                  ...
                  tempx1 = (rvec(1) - 3.0d0*zdiff(1)*rpv/r2) / r3
                  tempx2 = (rvec(2) - 3.0d0*zdiff(2)*rpv/r2) / r3
                  tempx3 = (rvec(3) - 3.0d0*zdiff(3)*rpv/r2) / r3
     ...
     1                 5.0d0*zdiff(1)*dpl*dpv/r2)/ r5
                  tempx2 = -3.0d0*(dlet(2)*dpv + dvec(2)*dpl -
     1                 5.0d0*zdiff(2)*dpl*dpv/r2)/ r5
     ...
     1                 5.0d0*zdiff(3)*dpl*dpv/r2)/ r5
                  ...
                  tempx1 = -(dlet(1) - 3.0d0*zdiff(1)*dpl/r2) / r3
                  tempx2 = -(dlet(2) - 3.0d0*zdiff(2)*dpl/r2) / r3
                  tempx3 = -(dlet(3) - 3.0d0*zdiff(3)*dpl/r2) / r3
                  ...
                  tempx1 = (dvec(1) - 3.0d0*zdiff(1)*dpv/r2) / r3
                  tempx2 = (dvec(2) - 3.0d0*zdiff(2)*dpv/r2) / r3
                  tempx3 = (dvec(3) - 3.0d0*zdiff(3)*dpv/r2) / r3
