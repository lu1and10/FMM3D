...
c
c     figure out rotlet - Laplace relations
...
c     convert to equivalent vector of laplace charges
      ...
      do i = 1,ns
         do l = 1,3
            dipvec(l,1,i) = rotvec(1,i)*rotstr(l,i) -
     1                      rotstr(1,i)*rotvec(l,i)
            dipvec(l,2,i) = rotvec(2,i)*rotstr(l,i) -
     1                      rotstr(2,i)*rotvec(l,i)
            dipvec(l,3,i) = rotvec(3,i)*rotstr(l,i) -
     1                      rotstr(3,i)*rotvec(l,i)
         enddo
      enddo

      call l3ddirectdg(ndl,source,dipvec,ns,targ,nt,potl,gradl,thresh)
