...
if( ntarg == 0 ) 
mex_id_ = 'lfmm3dpartself(io size_t[x], i size_t[x], i size_t[x], i double[xx], i size_t[x], i dcomplex[], i size_t[x], i dcomplex[], i double[xx], i size_t[x], io dcomplex[], i size_t[x], io dcomplex[])';
...
mex_id_ = 'lfmm3dparttarg(io size_t[x], i size_t[x], i size_t[x], i double[xx], i size_t[x], i dcomplex[], i size_t[x], i dcomplex[], i double[xx], i size_t[x], io dcomplex[], i size_t[x], io dcomplex[], i size_t[x], i double[], i size_t[x], io dcomplex[], i size_t[x], io dcomplex[])';
