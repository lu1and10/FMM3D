...
mex_id_ = 'h3dpartdirect(i dcomplex[x], i size_t[x], i double[xx], i size_t[x], i dcomplex[], i size_t[x], i dcomplex[], i double[xx], i size_t[x], io dcomplex[], i size_t[x], io dcomplex[], i size_t[x], i double[], i size_t[x], io dcomplex[], i size_t[x], io dcomplex[])';
