...
%  -  U.hesstarg: hessian at target locations, if requested, $\nabla^2 u(t_{i})$
  ...
  if(pgt == 1)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'l3ddirectcp(i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], i double[x])';
[pottarg] = fmm3d(mex_id_, nd, sources, charges, ns, targ, nt, pottarg, thresh, 1, 3, ns, nd, ns, 1, 3, nt, 1, nd, nt, 1);
    end
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'l3ddirectdp(i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], i double[x])';
[pottarg] = fmm3d(mex_id_, nd, sources, dipoles, ns, targ, nt, pottarg, thresh, 1, 3, ns, nd3, ns, 1, 3, nt, 1, nd, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'l3ddirectcdp(i size_t[x], i double[xx], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], i double[x])';
[pottarg] = fmm3d(mex_id_, nd, sources, charges, dipoles, ns, targ, nt, pottarg, thresh, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, 1, nd, nt, 1);
  ...
  if(pgt == 2)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'l3ddirectcg(i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, sources, charges, ns, targ, nt, pottarg, gradtarg, thresh, 1, 3, ns, nd, ns, 1, 3, nt, 1, nd, nt, nd3, nt, 1);
    ...
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'l3ddirectdg(i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, sources, dipoles, ns, targ, nt, pottarg, gradtarg, thresh, 1, 3, ns, nd3, ns, 1, 3, nt, 1, nd, nt, nd3, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'l3ddirectcdg(i size_t[x], i double[xx], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, sources, charges, dipoles, ns, targ, nt, pottarg, gradtarg, thresh, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, 1, nd, nt, nd3, nt, 1);
  ...
  if(pgt == 3)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'l3ddirectch(i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg, hesstarg] = fmm3d(mex_id_, nd, sources, charges, ns, targ, nt, pottarg, gradtarg, hesstarg, thresh, 1, 3, ns, nd, ns, 1, 3, nt, 1, nd, nt, nd3, nt, nd6, nt, 1);
    ...
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'l3ddirectdh(i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg, hesstarg] = fmm3d(mex_id_, nd, sources, dipoles, ns, targ, nt, pottarg, gradtarg, hesstarg, thresh, 1, 3, ns, nd3, ns, 1, 3, nt, 1, nd, nt, nd3, nt, nd6, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'l3ddirectcdh(i size_t[x], i double[xx], i double[xx], i double[xx], i size_t[x], i double[xx], i size_t[x], io double[xx], io double[xx], io double[xx], i double[x])';
