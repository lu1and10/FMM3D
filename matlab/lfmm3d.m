  ...
  if(iftarg == 0 || (pgt ~=1 && pgt ~=2)) 
    if(pg == 1)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_s_c_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx])';
[pot] = fmm3d(mex_id_, nd, eps, ns, sources, charges, pot, 1, 1, 1, 3, ns, nd, ns, nd, ns);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_s_d_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx])';
[pot] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, pot, 1, 1, 1, 3, ns, nd3, ns, nd, ns);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_s_cd_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], io double[xx])';
[pot] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, pot, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns);
    ...
    if(pg == 2)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_s_c_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx])';
[pot, grad] = fmm3d(mex_id_, nd, eps, ns, sources, charges, pot, grad, 1, 1, 1, 3, ns, nd, ns, nd, ns, nd3, ns);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_s_d_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx])';
[pot, grad] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, pot, grad, 1, 1, 1, 3, ns, nd3, ns, nd, ns, nd3, ns);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_s_cd_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], io double[xx], io double[xx])';
[pot, grad] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, pot, grad, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns, nd3, ns);
    ...
    if(pg == 3)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_s_c_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx], io double[xx])';
[pot, grad, hess] = fmm3d(mex_id_, nd, eps, ns, sources, charges, pot, grad, hess, 1, 1, 1, 3, ns, nd, ns, nd, ns, nd3, ns, nd6, ns);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_s_d_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx], io double[xx])';
[pot, grad, hess] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, pot, grad, hess, 1, 1, 1, 3, ns, nd3, ns, nd, ns, nd3, ns, nd6, ns);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_s_cd_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], io double[xx], io double[xx], io double[xx])';
[pot, grad, hess] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, pot, grad, hess, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns, nd3, ns, nd6, ns);
  ...
  if(iftarg == 1 && pg ~=1 && pg ~=2) 
    if(pgt == 1)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_t_c_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx])';
[pottarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, nt, targ, pottarg, 1, 1, 1, 3, ns, nd, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_t_d_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx])';
[pottarg] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, nt, targ, pottarg, 1, 1, 1, 3, ns, nd3, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_t_cd_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx])';
[pottarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, nt, targ, pottarg, 1, 1, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt);
    ...
    if(pgt == 2)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_t_c_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx], io double[xx])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, nt, targ, pottarg, gradtarg, 1, 1, 1, 3, ns, nd, ns, 1, 3, nt, nd, nt, nd3, nt);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_t_d_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx], io double[xx])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, nt, targ, pottarg, gradtarg, 1, 1, 1, 3, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_t_cd_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx], io double[xx])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, nt, targ, pottarg, gradtarg, 1, 1, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
    ...
    if(pgt == 3)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_t_c_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx], io double[xx], io double[xx])';
[pottarg, gradtarg, hesstarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, nt, targ, pottarg, gradtarg, hesstarg, 1, 1, 1, 3, ns, nd, ns, 1, 3, nt, nd, nt, nd3, nt, nd6, nt);
      ...
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_t_d_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx], io double[xx], io double[xx])';
[pottarg, gradtarg, hesstarg] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, nt, targ, pottarg, gradtarg, hesstarg, 1, 1, 1, 3, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt, nd6, nt);
      ...
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_t_cd_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], i size_t[x], i double[xx], io double[xx], io double[xx], io double[xx])';
[pottarg, gradtarg, hesstarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, nt, targ, pottarg, gradtarg, hesstarg, 1, 1, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt, nd6, nt);
  ...
  if(iftarg == 1 && (pg ==1 || pg ==2))
    ...
    if(pgt == 1)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_st_c_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], i size_t[x], i double[xx], io double[xx])';
[pot, pottarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, pot, nt, targ, pottarg, 1, 1, 1, 3, ns, nd, ns, nd, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_st_d_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], i size_t[x], i double[xx], io double[xx])';
[pot, pottarg] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, pot, nt, targ, pottarg, 1, 1, 1, 3, ns, nd3, ns, nd, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_st_cd_p_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], io double[xx], i size_t[x], i double[xx], io double[xx])';
[pot, pottarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, pot, nt, targ, pottarg, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns, 1, 3, nt, nd, nt);
    ...
    if(pgt == 2)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_st_c_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx], i size_t[x], i double[xx], io double[xx], io double[xx])';
[pot, grad, pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, pot, grad, nt, targ, pottarg, gradtarg, 1, 1, 1, 3, ns, nd, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
      ...
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_st_d_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx], i size_t[x], i double[xx], io double[xx], io double[xx])';
[pot, grad, pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, pot, grad, nt, targ, pottarg, gradtarg, 1, 1, 1, 3, ns, nd3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
      ...
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_st_cd_g_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], io double[xx], io double[xx], i size_t[x], i double[xx], io double[xx], io double[xx])';
[pot, grad, pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, dipoles, pot, grad, nt, targ, pottarg, gradtarg, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
    ...
    if(pgt == 3)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'lfmm3d_st_c_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx], io double[xx], i size_t[x], i double[xx], io double[xx], io double[xx], io double[xx])';
[pot, grad, hess, pottarg, gradtarg, hesstarg] = fmm3d(mex_id_, nd, eps, ns, sources, charges, pot, grad, hess, nt, targ, pottarg, gradtarg, hesstarg, 1, 1, 1, 3, ns, nd, ns, nd, ns, nd3, ns, nd6, ns, 1, 3, nt, nd, nt, nd3, nt, nd6, nt);
      ...
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'lfmm3d_st_d_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], io double[xx], io double[xx], io double[xx], i size_t[x], i double[xx], io double[xx], io double[xx], io double[xx])';
[pot, grad, hess, pottarg, gradtarg, hesstarg] = fmm3d(mex_id_, nd, eps, ns, sources, dipoles, pot, grad, hess, nt, targ, pottarg, gradtarg, hesstarg, 1, 1, 1, 3, ns, nd3, ns, nd, ns, nd3, ns, nd6, ns, 1, 3, nt, nd, nt, nd3, nt, nd6, nt);
      ...
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'lfmm3d_st_cd_h_vec(i size_t[x], i double[x], i size_t[x], i double[xx], i double[xx], i double[xx], io double[xx], io double[xx], io double[xx], i size_t[x], i double[xx], io double[xx], io double[xx], io double[xx])';
